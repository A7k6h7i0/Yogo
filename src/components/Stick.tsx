...
const Stick = () => {
  ...
  const features = [
    {
      title: "long life",
      desc: "you can use your sofi pod for a week between charges, and it takes about one hour to recharge fully with any usb-c cable",
      icon: (
    ...
    {
      title: "connected",
      desc: "your pod connects via bluetooth to the sofi app on your smartphone, allowing you to make new and unique discoveries with traditional plants",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      desc: "available in brushed aluminium slate and glossy white. we couldn’t decide on our favourite, so we're leaving the choice to you",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section ref={containerRef} className="bg-black py-32 text-white overflow-hidden relative">
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <motion.div style={{ y }} className="mb-32">
          ...
          >
            the sofi pod is designed to house our natural capsules and to provide a digital bridge with sofi's brain. with each spray, the pod exchanges information with the app, generating a journal of your capsule use, over time.
          </motion.p>
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            >
              it all starts with a <span className="text-transparent bg-clip-text bg-gradient-to-r from-white/40 to-white/10">sofi pod</span>
            </motion.h2>
          </div>
          ...
          >
            with the help of your input, sofi learns more about how different capsules benefit you, helping to create a personal playlist of your favourite plants.
          </motion.p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 relative">
          
          {/* Animated Stick Image in Center */}
          <motion.div 
            style={{ y: stickY }}
            className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-32 hidden md:block z-0 opacity-40 mix-blend-screen"
          >
             <img src="https://www.sofihealth.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fhand_white_pod.88284be9.webp&w=640&q=75" alt="Sofi Pod" className="h-full object-cover" />
          </motion.div>
